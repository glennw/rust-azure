...
pub fn AzDrawTargetCreateSourceSurfaceFromData(aDrawTarget: AzDrawTargetRef, aData: *mut u8, aSize: *mut AzIntSize, aStride: i32, aFormat: AzSurfaceFormat) -> AzSourceSurfaceRef;
...
pub fn AzCreateFontOptionsForData(aFontData: *mut u8, aFontDataSize: u32) -> *mut AzFontOptions;

pub fn AzCreateFontOptionsForName(aName: *mut c_char, aStyle: enum_AzFontStyle) -> *mut AzFontOptions;
